...
class PoeApi:
    ...
    def _emit_upload_action_log(self, file_name: str, file_content_type: str, file_size: int) -> None:
    ...
    def finish_upload(self, file_form: list) -> list:
        ...
        for file in file_form:
            ...
            try:
                self._emit_upload_action_log(file_name, file_content_type, file_size)
            except Exception as exc:
